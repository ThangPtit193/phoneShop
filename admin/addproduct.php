                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            ...
                            <form class="user" method="post" action="confirmproduct.php" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="" class="form-label">Các hình ảnh cho sản phẩm</label>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="sumary" id="" class="form-control"></textarea>
                            </div>
                            <div class="form-group">
