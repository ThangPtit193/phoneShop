            ...
            <div class="row">
                    ...
                    <div class="product__details__pic">
                        <div class="product__details__pic__item">
                            <img class="product__details__pic__item--large"
                                src="<?="admin/".$pic_arr[0]?>" alt="<?=$row['name']?>"
                            >
                        </div>
                        <div class="product__details__pic__slider owl-carousel">
                            <?php
                                for($i = 0; $i < count($pic_arr); $i++){
                                    ?>
                                         <img data-imgbigurl="<?="admin/".$pic_arr[$i]?>"
                                            src="<?="admin/".$pic_arr[$i]?>" alt="">
                                    <?php
                                }
                            ?>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text">
                        ...
                        <div class="product__details__price"><?=number_format($row['disscounted_price'], 0, ',', ',') . '₫';?></div>
                        <p><?=$row['summary']?></p>
                        <form method="post">
                        ...
                        <button class="primary-btn border-0" name="atcbtn">Thêm vào giỏ hàng</button>
                        </form>
            ...
            <div class="row">
                <?php
                    ...
                    while($row2 = mysqli_fetch_assoc($result2)){
                        $arr_img = explode(";", $row2['images']);
                        ?>
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                <div class="product__item">
                                    <div class="product__item__pic set-bg" data-setbg="<?="admin/".$arr_img[0]?>">
                                    ...
                                    <div class="product__item__text">
                                        ...
                                        <h5><?=number_format($row2['disscounted_price'], 0, ',', ',') . '₫'?></h5>
                                    </div>
                                </div>
                            </div>
                        <?php
